...
xseed_host="rtorrent-rutorrent-csmovie.ix-rtorrent-rutorrent.svc.cluster.local"
xseed_port="2469"
# Set a path to store this script's database of prior searched
log_file="/Loglocation"
# Optional; Set to "" to ignore
xseed_apikey="c9e7385786060df9844d62eaf6fb9237491b1df20aa1b893"
